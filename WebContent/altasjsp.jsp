		...
		<form action="AltasLibrosServlet" method="POST">
			...
			<div class="form-group row">
	               ...
	               <div class="col-sm-10">
	                   ...
	                   <input type="text" name="nombreLibro" id="nombreLibro" class="form-control" placeholder="Cual es el titulo del libro?" aria-label="book-title" aria-describedby="basic-addon1">
	                   </div>
	               </div>
	           </div>
	        ...
	        <div class="form-group row">
	               ...
	               <div class="col-sm-10">
	                   ...
	                   <input type="text" name="nombreAutor" id="nombreAutor" class="form-control" placeholder="Quien es el autor?" aria-label="book_author" aria-describedby="basic-addon1">
	                   </div>
	               </div>
	        </div>
			...
			<div class="form-group row">
					...
					<div class="col-sm-10">
					    ...
					    <input type="text" name="ISBN" id="ISBN" class="form-control" placeholder="Cual es el ISBN?" aria-label="book_ISNB" aria-describedby="basic-addon1">
					    </div>
					</div>
	        </div>
	           
	        <div class="form-group float-right">
	               <input class="btn btn-primary btn-lg new-color" type="submit" value="DAR ALTA"> 
	        </div>
